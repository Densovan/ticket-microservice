...
import com.denkh.user.dto.response.UserPaginationResponse;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    @Transactional
    public ResponseErrorTemplate create(CreateUserRequestDto userRequest) {
        ...
        if (userRequest.getRoles() == null || userRequest.getRoles().isEmpty()) {
            ...
            roleRepository.findAllByNameIn(userRequest.getRoles()).forEach(user::addRole);
        }

        // handle groups
        if (userRequest.getGroups() != null && !userRequest.getGroups().isEmpty()) {
            groupRepository.findAllByNameIn(userRequest.getGroups()).forEach(user::addGroup);
        }
    ...
    @Override
    @Transactional
    public ResponseErrorTemplate update(Long id, CreateUserRequestDto userRequest) {
