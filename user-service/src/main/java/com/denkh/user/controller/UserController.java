...
import com.denkh.common.exception.GeneralErrorResponse;
...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<ResponseErrorTemplate> create(@Validated @RequestBody CreateUserRequestDto userRequest) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseErrorTemplate> update(@PathVariable Long id, @Validated @RequestBody CreateUserRequestDto userRequest) {
